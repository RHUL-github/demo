...
/*****************************************************************************/
UINT32
TPMS_SIG_SCHEME_RAINBOW_Marshal(TPMS_SIG_SCHEME_RAINBOW *source, BYTE **buffer, UINT32 *size)
{
	UINT32 written = 0;
	written += TPMS_SCHEME_HASH_Marshal(source, buffer, size);
	return written;
...
TPMU_ASYM_SCHEME_Marshal(TPMU_ASYM_SCHEME  *source, BYTE **buffer, UINT32 *size, UINT32 selector)
{
    ...
    switch (selector) {
	  ...
	  case TPM_ALG_RAINBOW:
		  written += TPMS_SIG_SCHEME_RAINBOW_Marshal(&source->rainbow, buffer, size);
		  break;
#endif
#if ALG_KYBER
      case TPM_ALG_KYBER:
...
/*****************************************************************************/
UINT32
TPMI_ALG_RAINBOW_SCHEME_Marshal(TPMI_ALG_RAINBOW_SCHEME *source, BYTE **buffer, UINT32 *size)
{
	UINT32 written = 0;
	written += TPM_ALG_ID_Marshal(source, buffer, size);
	return written;
...
/*****************************************************************************/
UINT32
TPMT_LDAA_SCHEME_Marshal(TPMT_LDAA_SCHEME *source, BYTE **buffer, UINT32 *size)
{
    UINT32 written = 0;
...
/*****************************************************************************/
UINT32
TPMT_RAINBOW_SCHEME_Marshal(TPMT_RAINBOW_SCHEME *source, BYTE **buffer, UINT32 *size)
{
	UINT32 written = 0;

	written += TPMI_ALG_RAINBOW_SCHEME_Marshal(&source->scheme, buffer, size);
	written += TPMU_ASYM_SCHEME_Marshal(&source->details, buffer, size, source->scheme);
	return written;
}
/*****************************************************************************/
...
/*****************************************************************************/
UINT32
TPMS_SIGNATURE_RAINBOW_Marshal(TPMS_SIGNATURE_RAINBOW *source, BYTE **buffer, UINT32 *size)
{
	UINT32 written = 0;

	written += TPMI_ALG_HASH_Marshal(&source->hash, buffer, size);
	written += TPM2B_RAINBOW_SIGNED_MESSAGE_Marshal(&source->sig, buffer, size);
	return written;
}
/*****************************************************************************/
/*                             Rainbow Mods                                 */
...
#if ALG_RAINBOW
	  case TPM_ALG_RAINBOW:
		  written += TPMS_SIGNATURE_RAINBOW_Marshal(&source->rainbow, buffer, size);
		  break;
#endif
#if ALG_RSASSA
      case TPM_ALG_RSASSA:
...
#if ALG_RAINBOW
	  case TPM_ALG_RAINBOW:
		  written += TPM2B_RAINBOW_PUBLIC_KEY_Marshal(&source->rainbow, buffer, size);
		  break;
#endif
#if ALG_KYBER
      case TPM_ALG_KYBER:
...
/*****************************************************************************/
UINT32
TPMS_RAINBOW_PARMS_Marshal(TPMS_RAINBOW_PARMS *source, BYTE **buffer, UINT32 *size)
{
	UINT32 written = 0;

	written += TPMT_SYM_DEF_OBJECT_Marshal(&source->symmetric, buffer, size);
	written += TPMT_RAINBOW_SCHEME_Marshal(&source->scheme, buffer, size);
	return written;
}
/*****************************************************************************/
/*                             Rainbow Mods                                  */
...
#if ALG_RAINBOW
	  case TPM_ALG_RAINBOW:
		  written += TPMS_RAINBOW_PARMS_Marshal(&source->rainbowDetail, buffer, size);
		  break;
#endif
#if ALG_KYBER
      case TPM_ALG_KYBER:
...
#if ALG_RAINBOW
	  case TPM_ALG_RAINBOW:
		  written += TPM2B_RAINBOW_SECRET_KEY_Marshal(&source->rainbow, buffer, size);
		  break;
#endif
#if ALG_LDAA
      case TPM_ALG_LDAA:
...
UINT32
TPM2B_LDAA_SECRET_KEY_Marshal(TPM2B_LDAA_SECRET_KEY *source, BYTE **buffer, UINT32 *size)
{
    UINT32 written = 0;
    written += TPM2B_Marshal(&source->b, buffer, size);
    return written;
...
/*****************************************************************************/
UINT32
TPM2B_RAINBOW_PUBLIC_KEY_Marshal(TPM2B_RAINBOW_PUBLIC_KEY *source, BYTE **buffer, UINT32 *size)
{
	UINT32 written = 0;
	written += TPM2B_Marshal(&source->b, buffer, size);
	return written;
...
UINT32
TPM2B_RAINBOW_SECRET_KEY_Marshal(TPM2B_RAINBOW_SECRET_KEY *source, BYTE **buffer, UINT32 *size)
{
	UINT32 written = 0;
	written += TPM2B_Marshal(&source->b, buffer, size);
	return written;
...
UINT32
TPM2B_RAINBOW_SIGNED_MESSAGE_Marshal(TPM2B_RAINBOW_SIGNED_MESSAGE *source, BYTE **buffer, UINT32 *size)
{
	UINT32 written = 0;
	written += TPM2B_Marshal(&source->b, buffer, size);
	return written;
