...
#define MAX_SPHINCS_PLUS_MESSAGE_SIZE 64
#define MAX_SPHINCS_PLUS_SIGNED_MESSAGE_SIZE MAX_SPHINCS_PLUS_MESSAGE_SIZE+3366
...
typedef TPM_SPHINCS_PLUS_MODE TPMI_SPHINCS_PLUS_MODE;
